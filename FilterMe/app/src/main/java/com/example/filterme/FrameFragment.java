...
import com.example.filterme.Adapter.FrameAdapter;
...
public class FrameFragment extends BottomSheetDialogFragment implements FrameAdapter.FrameAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_add_freame = (Button)itemView.findViewById(R.id.btn_add_frame);
        ...
        btn_add_freame.setOnClickListener(new View.OnClickListener() {
            @Override
